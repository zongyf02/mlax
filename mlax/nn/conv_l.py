...
def init(
    ...
    """Intialize weights for a channel-last convolutional transform.
    ...
    :returns weight: Initialized kernel weight of shape
        ``(out_channels, *filter_shape, in_channels)``.
    """
    kernel_shape = (out_channels, *filter_shape, in_channels) 
...
def fwd(
    ...
    :param x: Input features to the convolutional transform. Must be
        channel-last.
    :param weights: Initialized kernel weights for a channel-last convolutional
        transform.
